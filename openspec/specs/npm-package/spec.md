## Purpose
The system provides an npm package `@champpaba/gslide` that wraps the Python CLI, enabling global installation, automatic environment setup, and self-update via npm.

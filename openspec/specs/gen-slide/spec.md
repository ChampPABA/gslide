...
Automates single-slide generation in Google Slides by driving the "Help me visualize" panel to create and insert slides, infographics, or images via a headless browser.
